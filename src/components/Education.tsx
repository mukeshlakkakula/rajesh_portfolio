...
const Education = () => {
    return (
        <section id="education" className="py-40 bg-[#010310] relative overflow-hidden">
            <div className="container mx-auto px-6 max-w-6xl">
                <div className="flex flex-col md:flex-row justify-between items-start gap-20">
                    <div className="sticky top-40 max-w-sm">
                        <h2 className="text-[10px] tracking-[0.3em] font-bold text-brand-light uppercase mb-8">05. EDUCATION</h2>
                    ...
                    <div className="flex-1 w-full pt-12">
                        <motion.div
                            ...
                            className="p-16 md:p-24 rounded-[4rem] bg-white/[0.02] border border-white/5 hover:border-brand/20 transition-all duration-700 hover:bg-white/[0.04]"
                        >
                            <div className="flex flex-col gap-10">
                                <div className="text-[12px] tracking-[0.5em] font-black text-brand/50 uppercase">DEGREE</div>
